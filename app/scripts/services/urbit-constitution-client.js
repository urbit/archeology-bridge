...
var customNode = require('../nodeHelpers/customNode');
  ...
  if (!offline) {
    ...
    ethFuncs.estimateGas(estObj, function(data) {
      if (data.error) {
        ...
        console.log("Gas estimation error. (This means you didn't call the contract correctly)");
      } else {
...
var readBalance = function(poolAddress, ajaxReq, wallet, callback) {
  if (poolAddress) {
    ...
    callback({ error: { msg: "No pool address has been entered." }, data: '' });
  }
}
//
